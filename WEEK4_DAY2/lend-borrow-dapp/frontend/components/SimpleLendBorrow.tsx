...
export function SimpleLendBorrow() {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-center">Lend & Borrow APT</h2>
      ...
      {/* Amount Input */}
      <div className="mb-6">
        <label className="block text-sm font-medium mb-2">Amount (APT)</label>
        <Input
          type="number"
          placeholder="0.0"
          value={amount}
